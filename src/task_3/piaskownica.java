...
public class piaskownica {
	public static void main(String[] args) {
		System.out.println("ARenc AMetz ASmoleń KStrzebońska KSkóra KSobczyk LSzetlak MPietruszewska OPułczyńska TKowalski"); //Stąd usuwacie siebie
