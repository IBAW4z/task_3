...
public class piaskownica {
	public static void main(String[] args) {
		System.out.println("ARenc AMetz KStrzebo�ska KSk�ra KSobczyk LSzetlak MPietruszewska TKowalski"); //St�d usuwacie siebie
        ...
        System.out.println("NAnna: Angels have the phone box-podejscie 2"); // ;)
			}
}
